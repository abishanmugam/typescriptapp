...
async function main() {
  ...
  if (!requester)
    throw new Error('REQUESTING_USER environment variable not set.');
  ...
  if (!postedComment)
    throw new Error('STATUS_COMMENT environment variable not set.');
  ...
  if (!fragment)
    throw new Error('Second argument must be a path to an HTML fragment.');
