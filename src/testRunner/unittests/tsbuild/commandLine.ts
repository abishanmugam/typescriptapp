  ...
  describe('different options::', () => {
    ...
    function withOptionChangeAndDiscrepancyExplanation(
      ...
      return {
        ...
        discrepancyExplanation: () => [
          `Clean build tsbuildinfo will have compilerOptions with composite and ${option.replace(
            /\-/g,
            ''
          )}`,
    ...
    function localChange(): TestTscEdit {
      return {
        ...
        edit: (fs) =>
          replaceText(fs, '/src/project/a.ts', 'Local = 1', 'Local = 10'),
      };
    }
  ...
  describe('emitDeclarationOnly::', () => {
    ...
    function verifyWithIncremental(options: ts.CompilerOptions) {
      verifyTsc({
        ...
        edits: [
          noChangeRun,
          {
            caption: 'local change',
            edit: (fs) =>
              appendText(fs, '/src/project1/src/a.ts', 'const aa = 10;'),
          },
          {
          ...
          },
          {
            ...
            edit: (fs) =>
              appendText(fs, '/src/project1/src/b.ts', 'const alocal = 10;'),
            commandLineArgs: ['--b', '/src/project2/src', '--verbose'],
          },
          {
            caption: 'local change',
            edit: (fs) =>
              appendText(fs, '/src/project1/src/b.ts', 'const aaaa = 10;'),
          ...
          },
          {
            caption: 'js emit with change without emitDeclarationOnly',
            edit: (fs) =>
              appendText(fs, '/src/project1/src/b.ts', 'export const a2 = 10;'),
            commandLineArgs: ['--b', '/src/project2/src', '--verbose'],
          },
        ],
        baselinePrograms: true,
      ...
      verifyTsc({
        ...
        edits: [
          ...
          },
          {
            ...
            edit: (fs) =>
              appendText(fs, '/src/project1/src/b.ts', 'const blocal = 10;'),
            commandLineArgs: [
              '--b',
              '/src/project2/src',
              '--verbose',
      ...
      function subScenario(text: string) {
        return `${text}${
          options.composite ? '' : ' with declaration and incremental'
    ...
    verifyTsc({
      ...
      edits: [
        ...
        },
        {
          caption: 'non local change',
          edit: (fs) =>
            appendText(fs, '/src/project1/src/a.ts', 'export const aaa = 10;'),
        },
        {
          caption: 'emit js files',
          edit: ts.noop,
