  ...
  verifyTscWatch({
    ...
    edits: [
      ...
      },
      {
        ...
        edit: (sys) => {
          sys.ensureFileOrFolder({
            path: getTsBuildProjectFilePath(
              'transitiveReferences',
              'nrefs/a.d.ts'
            ),
            content: sys.readFile(
              getTsBuildProjectFilePath('transitiveReferences', 'refs/a.d.ts')
            )!,
          });
      ...
      },
      {
        ...
        edit: (sys) =>
          sys.deleteFile(
            getTsBuildProjectFilePath('transitiveReferences', 'tsconfig.a.json')
          ),
        timeouts: (sys) => sys.checkTimeoutQueueLengthAndRun(1),
      },
      {
