...
describe('unittests:: config:: commandLineParsing:: parseCommandLine', () => {
  function assertParseResult(
    ...
    it(subScenario, () => {
      ...
      baseline.push(
        JSON.stringify(parsed.options, /*replacer*/ undefined, ' ')
      );
...
describe('unittests:: config:: commandLineParsing:: parseBuildOptions', () => {
  function assertParseResult(subScenario: string, commandLine: string[]) {
    it(subScenario, () => {
      ...
      baseline.push(
        JSON.stringify(parsed.buildOptions, /*replacer*/ undefined, ' ')
      );
      baseline.push('WatchOptions::');
      baseline.push(
        JSON.stringify(parsed.watchOptions, /*replacer*/ undefined, ' ')
  ...
  assertParseResult('reports other common may not be used with --build flags', [
    '--strict',
  ]);
