...
function assertParsed(
  actual: ts.ParsedCommandLine,
  expected: ts.ParsedCommandLine
): void {
...
function validateMatches(
...
) {
  {
    ...
    const actual = ts.parseJsonSourceFileConfigFileContent(
      result,
      host,
      basePath,
      existingOptions,
  ...
  {
    const actual = ts.parseJsonConfigFileContent(
      json,
      host,
      basePath,
      existingOptions,
