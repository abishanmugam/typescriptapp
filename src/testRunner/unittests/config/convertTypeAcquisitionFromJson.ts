...
describe('unittests:: config:: convertTypeAcquisitionFromJson', () => {
  ...
  function verifyAcquisition(
    actualTypeAcquisition: ts.TypeAcquisition | undefined,
    expectedResult: ExpectedResult
  ) {
  ...
  function assertTypeAcquisitionWithJson(
    ...
    const { options: actualTypeAcquisition, errors: actualErrors } =
      ts.convertTypeAcquisitionFromJson(jsonOptions, '/apath/', configFileName);
