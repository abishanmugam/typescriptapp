...
interface Document
  ...
  getElementsByTagName(
    tagname: 'x-ms-webview'
  ): NodeListOf<MSHTMLWebViewElement>;
  ...
  addEventListener(
    ...
    listener: (ev: MSSiteModeEvent) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
...
interface HTMLBodyElement extends HTMLElement {
  ...
  addEventListener(
    type: 'beforeunload',
    listener: (ev: BeforeUnloadEvent) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
    type: 'blur',
  ...
  addEventListener(
    type: 'hashchange',
    listener: (ev: HashChangeEvent) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
    type: 'input',
...
interface ScriptProcessorNode extends AudioNode {
  ...
  addEventListener(
    type: 'audioprocess',
    listener: (ev: AudioProcessingEvent) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
    type: string,
...
interface SubtleCrypto {
  ...
  deriveKey(
    algorithm: string | Algorithm,
    baseKey: CryptoKey,
    derivedKeyType: string | Algorithm,
    extractable: boolean,
    keyUsages: string[]
  ): any;
...
declare function msRequestAnimationFrame(
