...
declare namespace __React {
  ...
  interface DOMElement<P extends DOMAttributes<T>, T extends Element>
    extends ReactElement<P> {
    type: string;
    ref: Ref<T>;
  }
  ...
  interface ReactHTMLElement<T extends HTMLElement>
    extends DOMElement<HTMLAttributes<T>, T> {}
  ...
  interface DOMFactory<P extends DOMAttributes<T>, T extends Element> {
    (props?: P & ClassAttributes<T>, ...children: ReactNode[]): DOMElement<
      P,
      T
    >;
  }
  ...
  interface HTMLFactory<T extends HTMLElement>
    extends DOMFactory<HTMLAttributes<T>, T> {}
